...
class CertificateTest extends TestCase
{
    public function testCommon()
    {
        ...
        $this->assertSame(["commonName" => "www.kelunik.com", "names" => ["kelunik.com", "www.kelunik.com"], "issuedBy" => "Let's Encrypt Authority X1", "validFrom" => \date("d.m.Y", 1445636100), "validTo" => \date("d.m.Y", 1453412100)], $cert->__debugInfo());
    }
