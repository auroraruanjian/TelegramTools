...
class Parser
{
    ...
    {
        $comment = new Comment();
        $comment->setText($line)->setLineBreaks($lineBreaks);
        return $comment;
    }
    /**
    ...
    protected function parseDirectiveLine($line, \SplFileObject $file, $lineBreaks)
    {
        ...
        $directive->setName($name)->setArguments($args)->setLineBreaks($lineBreaks);
        return $directive;
    }
    /**
     * Parse a Block Line
    ...
    protected function parseBlockLine($line, \SplFileObject $file, $lineBreaks)
    {
        ...
        $block->setName($name)->setArguments($args)->setLineBreaks($lineBreaks);
