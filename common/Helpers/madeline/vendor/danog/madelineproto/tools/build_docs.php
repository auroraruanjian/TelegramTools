...
foreach (\array_slice($res, 0, -1) as $layer => $file) {
    $layer = "v{$layer}";
    $docs[] = ['tl_schema' => ['telegram' => $file], 'title' => 'MadelineProto API documentation (layer ' . $layer . ')', 'description' => 'MadelineProto API documentation (layer ' . $layer . ')', 'output_dir' => "{$d}/docs/old_docs/API_docs_" . $layer, 'readme' => true];
...
$docs = [
    ...
    ['tl_schema' => ['mtproto' => "{$d}/src/danog/MadelineProto/TL_mtproto_v1.json"], 'title' => 'MadelineProto API documentation (mtproto)', 'description' => 'MadelineProto API documentation (mtproto)', 'output_dir' => "{$d}/docs/docs/MTProto_docs", 'readme' => false],
    ['tl_schema' => ['telegram' => "{$d}/src/danog/MadelineProto/TL_telegram_v{$layer}.tl", 'calls' => "{$d}/src/danog/MadelineProto/TL_calls.tl", 'secret' => "{$d}/src/danog/MadelineProto/TL_secret.tl", 'td' => "{$d}/src/danog/MadelineProto/TL_td.tl"], 'title' => "MadelineProto API documentation (layer {$layer})", 'description' => "MadelineProto API documentation (layer {$layer})", 'output_dir' => "{$d}/docs/docs/API_docs", 'readme' => false],
];
...
' . $layer_list);
$doc = new \danog\MadelineProto\AnnotationsBuilder($logger, $docs[1], \dirname(__FILE__) . '/../src/danog/MadelineProto/InternalDoc.php', ['API' => API::class, 'APIFactory' => APIFactory::class, 'MTProto' => MTProto::class], 'danog\\MadelineProto');
$doc->mkAnnotations();
$ton = ['tl_schema' => ['lite_api' => "{$d}/src/danog/MadelineProto/TON/schemes/lite_api.tl", 'ton_api' => "{$d}/src/danog/MadelineProto/TON/schemes/ton_api.tl"]];
$doc = new \danog\MadelineProto\AnnotationsBuilder($logger, $ton, \dirname(__FILE__) . '/../src/danog/MadelineProto/TON/InternalDoc.php', ['API' => TONAPI::class, 'APIFactory' => TONAPIFactory::class, 'MTProto' => Lite::class], 'danog\\MadelineProto\\TON');
$doc->mkAnnotations();
...
\chdir(__DIR__ . '/..');
$orderedfiles = [];
$order = ['CREATING_A_CLIENT', 'LOGIN', 'FEATURES', 'REQUIREMENTS', 'INSTALLATION', 'UPDATES', 'SETTINGS', 'SELF', 'EXCEPTIONS', 'FLOOD_WAIT', 'LOGGING', 'CALLS', 'FILES', 'CHAT_INFO', 'DIALOGS', 'INLINE_BUTTONS', 'SECRET_CHATS', 'LUA', 'PROXY', 'ASYNC', 'USING_METHODS', 'CONTRIB', 'TEMPLATES'];
$index = '';
