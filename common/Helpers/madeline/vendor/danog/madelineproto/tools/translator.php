...
foreach (\danog\MadelineProto\Lang::$current_lang as $key => $value) {
    ...
    if (\danog\MadelineProto\Lang::$lang[$lang_code][$key] === $value && ($lang_code !== 'en' || $value == '' || \strpos($value, 'You cannot use this method directly') === 0 || \strpos($value, 'Update ') === 0 || \ctype_lower($value[0]))) {
