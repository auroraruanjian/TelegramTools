...
class InternalDoc extends APIFactory
{
     ...
     * @return \Generator
     */
    public function getConfig(array $config = [], array $options = [], array $extra = [])
    {
     ...
     * @return \Generator
     */
    public function methodCall(string $method, $args = [], array $aargs = ['msg_id' => null], array $extra = [])
    {
     ...
     * @return \Generator
     */
    public function methodCallWrite(string $method, $args = [], array $aargs = ['msg_id' => null], array $extra = [])
    {
        return $this->__call(__FUNCTION__, [$method, $args, $aargs, $extra]);
    }
    /**
     ...
     * @return ?array
     */
    public function extractBotAPIFile(array $info)
    {
     ...
     * @return void
     */
    public function rethrow(\Throwable $e, $file = '')
    {
     ...
     * @access public
     */
    public function setVar($obj, string $var, &$val)
    {
     ...
     * @return \Generator
     */
    public function discardCall(array $call, array $reason, array $rating = [], bool $need_debug = true, array $extra = [])
    {
