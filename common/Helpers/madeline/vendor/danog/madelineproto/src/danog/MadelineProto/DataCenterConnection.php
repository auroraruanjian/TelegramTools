...
class DataCenterConnection implements JsonSerializable
{
     ...
     * @return void
     */
    public function setAuthKey(AuthKey $key = null, bool $temp = true)
    {
     ...
     * @return void
     */
    public function setTempAuthKey(TempAuthKey $key = null)
    {
     ...
     * @return void
     */
    public function setPermAuthKey(PermAuthKey $key = null)
    {
