...
abstract class Socket
{
     ...
     * @return Promise<self>
     */
    public static abstract function connect(DelegateHttpClient $httpClient, Nameserver $nameserver) : self;
    /**
     * @param Message $message
     *
     * @return Promise<int>
     */
    protected abstract function resolve(Message $message) : Promise;
