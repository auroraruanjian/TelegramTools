...
{
    const ESTABLISHED = 0;
    const GOT_FIN_MASK = 1;
    const GOT_ACK_MASK = 2;
    const GOT_ALL_MASK = 3;
    ...
    {
        $this->channel = new ChannelledStream($this->read = new ResourceInputStream($read), $this->write = new ResourceOutputStream($write));
    }
    /**
     * {@inheritdoc}
     */
