 ...
 * <code>
 * <?php
 *    $a = new \tgseclib\Math\BigInteger(2);
 *    $b = new \tgseclib\Math\BigInteger(3);
 *
 *    $c = $a->add($b);
 *
...
class BigInteger implements \Serializable
{
    ...
    {
        self::$engines = [];
        $fqmain = 'tgseclib\\Math\\BigInteger\\Engines\\' . $main;
     ...
     * <code>
     * <?php
     *    $a = new \tgseclib\Math\BigInteger('10');
     *    $b = new \tgseclib\Math\BigInteger('20');
     *
