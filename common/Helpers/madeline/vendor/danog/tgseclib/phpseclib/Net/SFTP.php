 ...
 *
 *    $sftp = new \tgseclib\Net\SFTP('www.domain.tld');
...
use tgseclib\Exception\FileNotFoundException;
...
class SFTP extends SSH2
{
     ...
     *
     * \tgseclib\Net\SSH2::exec() uses 0 and \tgseclib\Net\SSH2::read() / \tgseclib\Net\SSH2::write() use 1.
     *
    ...
    public function __construct($host, $port = 22, $timeout = 10)
    {
        ...
        // the order, in this case, matters quite a lot - see \tgseclib\Net\SFTP::_parseAttributes() to understand why
        $this->attributes = [
        ...
        $this->open_flags = [0x1 => 'NET_SFTP_OPEN_READ', 0x2 => 'NET_SFTP_OPEN_WRITE', 0x4 => 'NET_SFTP_OPEN_APPEND', 0x8 => 'NET_SFTP_OPEN_CREATE', 0x10 => 'NET_SFTP_OPEN_TRUNCATE', 0x20 => 'NET_SFTP_OPEN_EXCL'];
        // http://tools.ietf.org/html/draft-ietf-secsh-filexfer-04#section-5.2
        // see \tgseclib\Net\SFTP::_parseLongname() for an explanation
        $this->file_types = [
        ...
        $this->define_array($this->packet_types, $this->status_codes, $this->attributes, $this->open_flags, $this->file_types);
    ...
    public function login($username,...$args)
    {
        ...
        */
        ...
        /*
         ...
         in draft-ietf-secsh-filexfer-13 would be quite impossible.  As such, what \tgseclib\Net\SFTP would do is close the
    ...
    public function chdir($dir)
    {
        ...
        // see \tgseclib\Net\SFTP::nlist() for a more thorough explanation of the following
        $response = $this->get_sftp_packet();
        switch ($this->packet_type) {
     ...
     * Returns general information about a file or symbolic link
     *
     * Determines information without calling \tgseclib\Net\SFTP::realpath().
     ...
     *
     * By default, \tgseclib\Net\SFTP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
     * So, for example, if you set $data to 'filename.ext' and then do \tgseclib\Net\SFTP::get(), you will get a file, twelve bytes
     ...
     * @throws \tgseclib\Exception\FileNotFoundException if you're uploading via a file and the file doesn't exist
     * @return bool
     * @access public
     * @internal ASCII mode for SFTPv4/5/6 can be supported by adding a new function - \tgseclib\Net\SFTP::setMode().
     */
