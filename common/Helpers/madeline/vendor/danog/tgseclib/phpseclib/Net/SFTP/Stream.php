...
class Stream
{
    ...
    private function parse_path($path)
    {
        ...
        if (preg_match('/^{[a-z0-9]+}$/i', $host)) {
            ...
            // casting $pass to a string is necessary in the event that it's a \tgseclib\Crypt\RSA object
     ...
     * If newname exists, it will be overwritten.  This is a departure from what \tgseclib\Net\SFTP
     * does.
     *
     ...
     * Flushes the output
     *
     * See <http://php.net/fflush>. Always returns true because \tgseclib\Net\SFTP doesn't cache stuff before writing
     *
     * @return bool
     * @access public
     */
     ...
     *
     * Ignores the STREAM_URL_STAT_QUIET flag because the entirety of \tgseclib\Net\SFTP\Stream is quiet by default
     ...
     * The other two aren't supported because of limitations in \tgseclib\Net\SFTP.
     *
     * @param int $option
     * @param int $arg1
     * @param int $arg2
