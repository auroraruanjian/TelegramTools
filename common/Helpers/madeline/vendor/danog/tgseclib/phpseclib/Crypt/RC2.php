...
class RC2 extends BlockCipher
{
     ...
     * The Key
     *
     * @see \tgseclib\Crypt\Common\SymmetricKey::key
     * @see self::setKey()
     * @var string
     * @access private
     */
     ...
     *
     * @see \tgseclib\Crypt\Common\SymmetricKey::clearBuffers()
     * @var bool
     * @access private
     */
     ...
     * Key Length (in bytes)
     *
     * @see \tgseclib\Crypt\RC2::setKeyLength()
     * @var int
     * @access private
     */
     ...
     * Encrypts a message.
     *
     * Mostly a wrapper for \tgseclib\Crypt\Common\SymmetricKey::encrypt, with some additional OpenSSL handling code
     *
     * @see self::decrypt()
     * @access public
     ...
     * Decrypts a message.
     *
     * Mostly a wrapper for \tgseclib\Crypt\Common\SymmetricKey::decrypt, with some additional OpenSSL handling code
     *
     * @see self::encrypt()
     * @access public
    ...
    protected function setupKey()
    {
        ...
        // Key has already been expanded in \tgseclib\Crypt\RC2::setKey():
