...
interface QueryInterface extends \Countable, \IteratorAggregate, UriComponentInterface
{
     ...
     * @param ?string $value
     */
    public function withPair(string $key, string $value = null) : self;
    /**
     ...
     * @param ...$keys
     */
    public function withoutPair(...$keys) : self;
    /**
     ...
     * @param ?string $value
     */
    public function appendTo(string $key, string $value = null) : self;
    /**
     ...
     * @param ...$keys
     */
    public function withoutParam(...$keys) : self;
}