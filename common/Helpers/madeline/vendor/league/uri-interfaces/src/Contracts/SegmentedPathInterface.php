...
interface SegmentedPathInterface extends \Countable, \IteratorAggregate, PathInterface
{
     ...
     */
    public function withSegment(int $key, string $segment = null) : self;
    /**
     ...
     *
     * @param ...$keys remaining keys to remove
     *
     * @throws SyntaxError If the key is invalid
     */
    public function withoutSegment(...$keys) : self;
    /**
     ...
     * @param ?string $path
     */
    public function withDirname(string $path = null) : self;
    /**
     ...
     */
    public function withBasename(string $basename = null) : self;
    /**
     ...
     */
    public function withExtension(string $extension = null) : self;
}