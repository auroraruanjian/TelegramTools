...
final class TlsInfo
{
     ...
     */
    public static function fromStreamResource($resource)
    {
    ...
    private function __construct(string $version, string $cipherName, int $cipherBits, string $cipherVersion, string $alpnProtocol = null, array $certificates = null)
    {
    ...
    public function getApplicationLayerProtocol()
    {
