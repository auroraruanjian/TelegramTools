...
class DatagramSocketTest extends TestCase
{
     ...
     */
    public function testBindEndpointInvalidScheme()
    {
     ...
     */
    public function testBindEndpointError()
    {
    ...
    public function testReceive()
    {
        Loop::run(function () {
            ...
            asyncCall(function () use($endpoint, $remote) {
                while (list($address, $data) = (yield $endpoint->receive())) {
    ...
    public function testSetChunkSize()
    {
        Loop::run(function () {
            ...
            try {
                ...
                \assert($socket instanceof Socket\EncryptableSocket);
                (yield $socket->write('Hello!'));
                list($address, $data) = (yield $endpoint->receive());
