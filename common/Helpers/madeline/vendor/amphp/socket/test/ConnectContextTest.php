...
class ConnectContextTest extends TestCase
{
    ...
    {
        return [[null], [Record::AAAA], [Record::A]];
    }
    /**
    ...
    public function testToStreamContextArray()
    {
        ...
        $expected = ['socket' => ['tcp_nodelay' => false, 'bindto' => '127.0.0.1:12345'], 'ssl' => ['crypto_method' => ClientTlsContext::TLSv1_0 | ClientTlsContext::TLSv1_1 | ClientTlsContext::TLSv1_2, 'peer_name' => 'amphp.org', 'verify_peer' => true, 'verify_peer_name' => true, 'verify_depth' => 10, 'ciphers' => \OPENSSL_DEFAULT_STREAM_CIPHERS, 'capture_peer_cert' => false, 'capture_peer_cert_chain' => false, 'SNI_enabled' => true]];
