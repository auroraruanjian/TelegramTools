...
class functionsTest extends TestCase
{
    ...
    {
        return [['unix:///tmp/test', ['unix', 'tmp/test', 0]], ['udg://test', ['udg', 'test', 0]], ['tcp://test:1234', ['tcp', 'test', 1234]], ['udp://host:4321', ['udp', 'host', 4321]], ['tcp://[2001:db8:85a3:8d3:1319:8a2e:370:7348]:443', ['tcp', '[2001:db8:85a3:8d3:1319:8a2e:370:7348]', 443]]];
    }
    /**
    ...
    {
        return [['http://example.com'], ['https://example.com'], ['xml://example.com']];
    }
    /**
    ...
    {
        return [[null, null], ['127.0.0.1', '127.0.0.1:0'], ['127.0.0.1:0', '127.0.0.1:0'], ['123.123.123.123:1234', '123.123.123.123:1234'], ['[::1]', '[::1]:0'], ['[a:b::c]', '[a:b::c]:0'], ['[1:2::3]:4', '[1:2::3]:4'], ['[0000:abcd:0000:abcd:0000:abcd:0127:2258]:4567', '[0000:abcd:0000:abcd:0000:abcd:0127:2258]:4567']];
    }
    /**
    ...
    {
        return [['-1.-1.-1.-1'], ['a.b.c.d'], ['123.123.123.123:-0'], ['123.123.123.123:-1234567'], ['[0000:abcd:0000:abcd:0000:abcd:0127:2258]:-67899'], ['[e:f:g:h]']];
    }
    /**
    ...
    {
        return [['123.123.123.123:123456'], ['[0000:abcd:0000:abcd:0000:abcd:0127:2258]:67899']];
    }
    /**
    ...
    {
        return [['256.256.256.256'], ['1234.12.12.12']];
    }
    /**
