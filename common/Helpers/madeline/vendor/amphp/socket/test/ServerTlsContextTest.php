...
class ServerTlsContextTest extends TestCase
{
    ...
    {
        return [[ServerTlsContext::TLSv1_0], [ServerTlsContext::TLSv1_1], [ServerTlsContext::TLSv1_2]];
    }
    /**
    ...
    {
        return [[null], [new Certificate('test')]];
    }
    /**
    ...
    public function testWithSecurityLevelValid($level)
    {
        if (\OPENSSL_VERSION_NUMBER >= 0x10100000) {
            $value = (new ServerTlsContext())->withSecurityLevel($level)->getSecurityLevel();
