...
abstract class LinkTest extends AsyncTestCase
{
     ...
     * @return Promise<Link>
     */
    protected abstract function getLink(string $connectionString) : Promise;
    ...
    public function testPrepared()
    {
        ...
        $base = ["catalog" => "def", "schema" => "test", "table" => "main", "original_table" => "main", "charset" => 63, "columnlen" => 11, "type" => 3, "flags" => 0, "decimals" => 0];
    ...
    public function testBindWithInvalidParamId()
    {
        ...
        // Some implementations do not throw until execute() is called.
    }
