...
class StatementTest extends AsyncTestCase
{
    ...
    {
        return ['test scalar' => ['data' => 1, 'expectedException' => null], 'test object' => ['data' => (object) [], 'expectedException' => 'TypeError'], 'test array' => ['data' => [], 'expectedException' => 'TypeError'], 'test object with __toString defined' => ['data' => new class
        {
