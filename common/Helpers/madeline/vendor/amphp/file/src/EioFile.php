...
final class EioFile implements File
{
    ...
    public function read(int $length = self::DEFAULT_READ_LENGTH) : Promise
    {
        ...
        \eio_read($this->fh, $length, $this->position, \EIO_PRI_DEFAULT, $onRead, $deferred);
    ...
    private function push(string $data) : Promise
    {
        ...
        \eio_write($this->fh, $data, $length, $this->position, \EIO_PRI_DEFAULT, $onWrite, $deferred);
        return $deferred->promise();
    }
    /**
     * {@inheritdoc}
    ...
    private function trim(int $size) : Promise
    {
        ...
        \eio_ftruncate($this->fh, $size, \EIO_PRI_DEFAULT, $onTruncate, $deferred);
        return $deferred->promise();
    }
    /**
     * {@inheritdoc}
