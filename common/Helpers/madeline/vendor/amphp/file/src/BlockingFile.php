...
final class BlockingFile implements File
{
    ...
    public function read(int $length = self::DEFAULT_READ_LENGTH) : Promise
    {
        ...
        return new Failure(new StreamException("Failed reading from file handle"));
    }
    /**
     * {@inheritdoc}
     */
    public function write(string $data) : Promise
    {
        ...
        return new Failure(new StreamException("Failed writing to file handle"));
    }
    /**
     * {@inheritdoc}
     */
    ...
    public function close() : Promise
    {
        ...
        return new Failure(new StreamException("Failed closing file handle"));
    }
    /**
     * {@inheritdoc}
     */
