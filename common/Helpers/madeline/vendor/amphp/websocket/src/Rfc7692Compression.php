...
final class Rfc7692Compression implements CompressionContext
{
    ...
    const RSV = 0b100;
    const MINIMUM_LENGTH = 860;
    const EMPTY_BLOCK = "\0\0ÿÿ";
    /**
     ...
     * @return self|null
     */
    public static function fromClientHeader(string $headerIn, string &$headerOut = null)
    {
     ...
     * @return self|null
     */
    public static function fromServerHeader(string $header)
    {
     ...
     * @return self|null
     */
    private static function fromHeader(bool $isServer, string $headerIn, string &$headerOut = null)
    {
    ...
    private function __construct(int $receivingWindowSize, int $sendingWindowSize, bool $receivingContextTakeover, bool $sendingContextTakeover)
    {
    ...
    public function decompress(string $data, bool $isFinal)
    {
        if ($isFinal) {
