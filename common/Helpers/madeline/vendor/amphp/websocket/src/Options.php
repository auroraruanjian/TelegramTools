...
final class Options
{
    ...
    // 32KB
    private $bytesPerSecondLimit = 1048576;
    // 1MB
    private $framesPerSecondLimit = 100;
    private $frameSizeLimit = 2097152;
    // 2MB
    private $messageSizeLimit = 10485760;
    // 10MB
    ...
    {
        return new self();
        // Initial parameter values already tuned for servers.
    }
    /**
    ...
    public static function createClientDefault() : self
    {
        ...
        $options->messageSizeLimit = 2 ** 30;
        // 1 GB
        $options->frameSizeLimit = 2 ** 20 * 100;
        // 100 MB
