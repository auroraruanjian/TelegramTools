...
class Rfc7230Test extends TestCase
{
    ...
    public function testValidHeaderParsing(string $rawHeaders, array $expectedResult)
    {
        ...
        $headers = [];
        foreach ($expectedResult as list($name, $value)) {
    ...
    /** @dataProvider provideValidHeaders */
    public function testValidRawHeaderFormatting(string $rawHeaders, array $expectedResult)
    {
        $result = Rfc7230::parseRawHeaders(Rfc7230::formatRawHeaders($expectedResult));
        $this->assertSame($result, $expectedResult);
    }
    /** @dataProvider provideValidHeaders */
    public function testValidHeaderFormattingDifferentCasing(string $rawHeaders, array $expectedResult)
    {
        $headers = [];
        foreach ($expectedResult as list($name, $value)) {
            // No strtolower
    ...
    {
        return [["x:y\r\n", [["x", "y"]]], ["server:\tamphp.org\r\n", [["server", "amphp.org"]]], ["server: \tamphp.org  \t \r\n", [["server", "amphp.org"]]], ["server: \tamphp.org  \t \r\nServer: amphp.org\r\n", [["server", "amphp.org"], ["Server", "amphp.org"]]], ["ser124ver:\tamphp.org\r\n", [["ser124ver", "amphp.org"]]], ["123: 321\r\n", [['123', '321']]], ["AbC: Test\r\n", [['AbC', 'Test']]]];
    }
    ...
    {
        $headers = ["foobar" => ["bar"], ":method" => ["GET"], "x" => ["y"]];
