...
class MessageTest extends TestCase
{
    ...
    {
        $message = new TestMessage(['X-FooBar' => 'bar', 'X-Replace' => 'none']);
        ...
        $this->assertSame([['X-FooBar', 'bar'], ['x-fooBar', 'baz'], ['x-rePlace', 'yes'], ['x-again', 'hello']], $message->getRawHeaders());
    }
    public function testGetHeader()
    {
        $message = new TestMessage(['foo' => 'bar']);
