...
class NativeDecoderFactory
{
    ...
    public function create(TypeDefinitionManager $typeDefinitionManager = null) : NativeDecoder
    {
        ...
        return new NativeDecoder(new PacketFactory(), new MessageFactory(new RecordCollectionFactory()), new QuestionFactory(), $typeBuilder, new EncodingContextFactory(), new DecoderFactory());
    }
}