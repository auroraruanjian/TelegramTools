    ...
    public function testGetters() : \Generator
    {
        $this->givenNetworkInterceptor(new class($this) implements NetworkInterceptor
        {
            ...
            public function requestViaNetwork(Request $request, CancellationToken $cancellation, Stream $stream) : Promise
            {
                ...
                TestCase::assertSame($this->testCase->getServerAddress()->toString(), $stream->getRemoteAddress()->toString());
                TestCase::assertSame('127.0.0.1', $stream->getLocalAddress()->getHost());
                TestCase::assertNotSame($this->testCase->getServerAddress()->toString(), $stream->getLocalAddress()->toString());
