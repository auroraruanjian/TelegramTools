...
class ResponseTest extends AsyncTestCase
{
    ...
    public function testPseudoSetHeader()
    {
        ...
        (new Response('2', 200, null, [], new InMemoryStream(), new Request('https://google.com/')))->setHeader(':foobar', 'foobar');
    }
    public function testEmptySetHeader()
    {
        $this->expectExceptionMessage('Header name cannot be empty or start with a colon (:)');
        (new Response('2', 200, null, [], new InMemoryStream(), new Request('https://google.com/')))->setHeader('', 'foobar');
    }
    public function testPseudoAddHeader()
    {
        $this->expectExceptionMessage('Header name cannot be empty or start with a colon (:)');
        (new Response('2', 200, null, [], new InMemoryStream(), new Request('https://google.com/')))->addHeader(':foobar', 'foobar');
    }
    public function testEmptyAddHeader()
    {
        $this->expectExceptionMessage('Header name cannot be empty or start with a colon (:)');
        (new Response('2', 200, null, [], new InMemoryStream(), new Request('https://google.com/')))->addHeader('', 'foobar');
    }
    ...
    public function testPreviousResponse()
    {
        $response = $this->createResponse();
    ...
    {
        return new Response('1.1', 200, 'OK', [], new InMemoryStream(), new Request('https://example.com/'));
    }
}