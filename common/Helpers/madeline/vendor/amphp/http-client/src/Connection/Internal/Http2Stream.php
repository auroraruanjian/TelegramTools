...
final class Http2Stream
{
    ...
    public function __construct(int $id, Request $request, Stream $stream, CancellationToken $cancellationToken, CancellationToken $originalCancellation, int $serverSize, int $clientSize)
    {
        $this->id = $id;
