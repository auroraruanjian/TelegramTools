...
final class Http2Connection implements Connection
{
    ...
    public function getStream(Request $request) : Promise
    {
        ...
        return call(function () {
            ...
            return HttpStream::fromConnection($this, $this->callableFromInstanceMethod('request'), $this->processor->callableFromInstanceMethod('unreserveStream'));
        });
    }
