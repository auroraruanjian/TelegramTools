...
final class HttpStream implements Stream
{
    ...
    private function __construct(SocketAddress $localAddress, SocketAddress $remoteAddress, TlsInfo $tlsInfo = null, callable $requestCallback, callable $releaseCallback)
    {
