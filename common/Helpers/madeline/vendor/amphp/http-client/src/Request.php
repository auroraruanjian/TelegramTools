...
final class Request extends Message
{
    ...
    const DEFAULT_HEADER_SIZE_LIMIT = 2 * 8192;
    const DEFAULT_BODY_SIZE_LIMIT = 10485760;
     ...
     */
    public function setProtocolVersions(array $versions)
    {
     ...
     */
    public function setPushHandler(callable $onPush = null)
    {
        $this->onPush = $onPush;
    }
    /**
     ...
     */
    public function interceptPush(callable $interceptor)
    {
        if ($this->onPush === null) {
            return;
        }
     ...
     */
    public function setInformationalResponseHandler(callable $onInformationalResponse = null)
    {
     ...
     * @return callable|null
     */
    public function getInformationalResponseHandler()
    {
    ...
    public function setTcpConnectTimeout(int $tcpConnectTimeout)
    {
    ...
    public function setTlsHandshakeTimeout(int $tlsHandshakeTimeout)
    {
    ...
    public function setTransferTimeout(int $transferTimeout)
    {
    ...
    public function setHeaderSizeLimit(int $headerSizeLimit)
    {
    ...
    public function setBodySizeLimit(int $bodySizeLimit)
    {
