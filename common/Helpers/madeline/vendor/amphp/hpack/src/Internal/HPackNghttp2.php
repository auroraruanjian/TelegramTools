...
{
    const FLAG_NO_INDEX = 0x1;
    const FLAG_NO_COPY_NAME = 0x2;
    const FLAG_NO_COPY_VALUE = 0x4;
    const FLAG_NO_COPY = self::FLAG_NO_COPY_NAME | self::FLAG_NO_COPY_VALUE;
    const FLAG_NO_COPY_SENSITIVE = self::FLAG_NO_COPY | self::FLAG_NO_INDEX;
    const SENSITIVE_HEADERS = ['authorization' => self::FLAG_NO_COPY_SENSITIVE, 'cookie' => self::FLAG_NO_COPY_SENSITIVE, 'proxy-authorization' => self::FLAG_NO_COPY_SENSITIVE, 'set-cookie' => self::FLAG_NO_COPY_SENSITIVE];
    private static $ffi;
    ...
    public function encode(array $headers) : string
    {
        ...
        foreach ($headers as $index => list($name, $value)) {
