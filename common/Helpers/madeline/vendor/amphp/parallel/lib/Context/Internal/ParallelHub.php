...
class ParallelHub extends ProcessHub
{
    ...
    public function __construct()
    {
        ...
        $this->watcher = Loop::repeat(self::EXIT_CHECK_FREQUENCY, static function () use(&$channels, $events) {
    ...
    public function add(int $id, ChannelledSocket $channel, Future $future)
    {
