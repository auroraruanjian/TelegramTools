...
class ClientCookieTest extends CookieTest
{
    ...
    public function setUp()
    {
        ...
        $this->client = (new HttpClientBuilder())->usingPool(new UnlimitedConnectionPool(new StaticConnector($this->address, connector())))->interceptNetwork(new CookieInterceptor($this->jar))->build();
    }
    /**
