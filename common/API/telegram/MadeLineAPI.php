...
use Amp\Promise;
use danog\MadelineProto\Absolute;
...
class MadeLineAPI extends API
{
     ...
     * @return void
     */
    public function __magic_construct(string $session, array $settings = [])
    {
     ...
     * @return void
     */
    public function startAndLoop(string $eventHandler)
    {
        while (true) {
            try {
     ...
     * @return Promise
     */
    public static function startAndLoopMulti(array $instances, $eventHandler)
    {
